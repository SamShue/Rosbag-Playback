classdef robotmappf < handle
    ...
    methods
        ...
        function resample(obj, landmarkRanges, landmarkId)
            ...
            lidx = find(obj.landmarkIds == landmarkId);
            ...
            if(~isempty(lidx))
                ...
                for ii = 1:obj.numParticles
                    ...
                    newParticles(ii,lidx) = newParticles(ii,lidx) + normrnd(0, 0.025);
                    newParticles(ii,lidx + 1) = newParticles(ii,lidx + 1) + normrnd(0, 0.025);
                end
